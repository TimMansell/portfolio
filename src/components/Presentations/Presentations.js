        ...
        <ul className="skills__list">
          <li className="skills__item">
            <a
              ...
              href="https://timmansell.github.io/presentations/web-components/index.html"
              target="_blank"
          ...
          <li className="skills__item">
            <a
              className="link link--alt"
              href="//docs.google.com/presentation/d/1ZE8mvgP5G_Th9zgRMEsbNZwAoKpsuWpacVbC1Y1C0GY"
              target="_blank"
              rel="noopener noreferrer"
            >
