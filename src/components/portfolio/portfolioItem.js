...
export class PortfolioItem extends React.Component {
    render() {
        return <div className="portfolio-item">
            <InViewport>
                <img className="img--responsive" src={this.props.data.thumb} alt={this.props.data.title} />
            </InViewport>
            
            <div className="portfolio-item__info">
                <h3 className="portfolio-item__title">{this.props.data.title}</h3>
                <p className="portfolio-item__description">{this.props.data.description}</p>
                <p className="portfolio-item__tech">{this.props.data.tech}</p>
